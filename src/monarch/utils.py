...
def strain_outputs(model, outputs, time_g=0, dense_time_frame=50):
    ...
    n_patch = len(model.heart.patches)
    ...
    for i in range(n_patch):
        ...
        max_strain = np.max(model.heart.lab_f[:, i])
        del_strain = max_strain - np.min(model.heart.lab_f[:, i])
...
def get_outputs(model, time_g=0, match_strain=False):
    ...
    outputs = pd.DataFrame([[edv, esv, edp, esp, p_max, dpdt_max, dpdt_min, sv, rf, ef, co,
                             ...
                             edv_i, esv_i, rvedv_i, rvesv_i, max_strain[0], max_strain[1], max_strain[2], max_strain[3],
                             max_strain[4], max_strain[5], max_strain[6], max_strain[7]], max_strain[8], max_strain[9],
                             max_strain[10], max_strain[11], max_strain[12], max_strain[13], max_strain[14], max_strain[15]],
                        columns=['LVEDV', 'LVESV', 'LVEDP', 'LVESP', 'LVMaxP', 'LVMaxdP', 'LVMindP', 'LVSV', 'LVRF', 'LVEF', 'LVCO',
                                 ...
                                 'LVEDVi', 'LVESVi', 'RVEDVi', 'RVESVi', 'MaxStrain1', 'MaxStrain2', 'MaxStrain3', 'MaxStrain4',
                                 'MaxStrain5', 'MaxStrain6', 'MaxStrain7', 'MaxStrain8', 'MaxStrain9', 'MaxStrain10', 'MaxStrain11',
                                 'MaxStrain12', 'MaxStrain13', 'MaxStrain14', 'MaxStrain15'],
                        index=[time_g])
